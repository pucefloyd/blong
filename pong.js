...
function Player() {
  this.paddle = new Paddle(300, 380, 5 , 10);
}
...
function Computer() {
  this.paddle = new Paddle(300, 10, 5, 10);
}
...
Ball.prototype.update = function(paddle1, paddle2, score) {
  ...
  if(this.y < 0 || this.y > 600) { // a point was scored
    ...
    if(this.y < 0) {
      scorePlayer.addPlayer();
    }
    if(this.y > 600) {
      scoreComputer.addComputer();
    }
    this.x = 200;
    this.y = 300;
  }
...
ScoreComputer.prototype.addComputer = function() {
  this.computerScore++;
}

ScorePlayer.prototype.addPlayer = function() {
  this.playerScore++;
}
...
ScorePlayer.prototype.render = function() {
  context.fillStyle = "white";
  context.fillText(this.playerScore, 375, 30);
}
